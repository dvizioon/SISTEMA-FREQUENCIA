        ...
        $ID = $_SESSION['id_proff'];
            ...
            if(isset($_SESSION['id_proff'])){
                ...
                if($ID == ""){
                        ...
                        header("Location:_perfil_proff.php?prof={$_SESSION['id_proff']}");
                        return false;
                }
                else{
                    if($_id == "" || $ID == ""){
...
<div class="conteiner-back">
    ...
    <h2 class="free-contente">Perfil da professor(a) <?php echo $Nome_proff; ?></h2>
    <?php
    ...
    ?>
    <div class="conteiner_box_principal" style="width:450px;">
        <div class="sub_conteiner_box_principal" style="width:430px;">
            <div class="name_edit">

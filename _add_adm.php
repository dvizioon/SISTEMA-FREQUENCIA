...
<div class="conteiner-back">
    ...
    <h2 class="free-contente">Adicionar Adm &rarr;</h2>
    <?php
    ...
    ?>
    <div class="conteiner_box_principal" style="width:490px;">
        <div class="sub_conteiner_box_principal" style="width:450px;">
        <h1  style="text-align:center;font-size:37px;font-family:bebas-neue, sans-serif;font-weight: bold;margin-top:20px;">Adicionar Administrador</h1>
            ...
            <div class="sub_name_edit" style="left:37%;" >
            <form action="salvar_add_adm.php?adm=<?php echo $id_adm ?>" method="POST">
            <div class="sub_card_name_edit" style="margin-top:105px;">
                ...
                <?php
                  echo "<input type='text' name = 'name_adm' placeholder='Digite nome Adm...' maxlength='10'>";
                ?>
            </div>
            ...
            <path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 12.5V5a1 1 0 0 1-1-1V2zm2 3v7.5A1.5 1.5 0 0 0 3.5 14h9a1.5 1.5 0 0 0 1.5-1.5V5H2zm13-3H1v2h14V2zM5 7.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>
                ...
                <?php
                     echo "<input type='text' name='cpf_adm' placeholder='Digite cpf Adm...' maxlength='14'>";
                ?>
            </div>
            <div  class="sub_card_name_edit">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFF" viewBox="0 0 16 16">
            ...
            <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
                ...
                <?php
                     echo "<input type='text' name='senha_adm' placeholder='Digite senha Adm...' maxlength='10'>";
                ?>
            </div>
            ...
            <div  class="sub_card_name_edit">
                ...
                <?php
                    echo "<select name='op_setor'>
                    <option value='none'>setor...</opttion>
                    <option value='administracao'>administracao</opttion>
                   </select>";
                ?>
            </div>
            <div  class="sub_card_name_edit">
            ...
            <path d="M2 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H9.5a1 1 0 0 0-1 1v7.293l2.646-2.647a.5.5 0 0 1 .708.708l-3.5 3.5a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L7.5 9.293V2a2 2 0 0 1 2-2H14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h2.5a.5.5 0 0 1 0 1H2z"/>
                ...
                <?php
                    echo "<input type='hidden' name='id_adm_saved' value='{$_SESSION['id_admin']}'>";
                    echo "<input type='submit' name='update_submit_adm'  value='Enviar' >";
                ?>
            </div>
            </form>

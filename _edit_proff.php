<?php
    ...
    $query = "SELECT * FROM professor WHERE id_proff='{$_GET['prof']}'";
    ...
    if(isset($_GET['prof'])){
        ...
        $_id = $_GET['prof'];
        $_SESSION['id_proff']=$_id;

            if(isset($_SESSION['id_proff'])){

                $_ID = $_SESSION['id_proff'];

                if($_ID == ""){
                        $_SESSION['par_ennor'] = true;
                        header("Location:_edit_proff.php?prof={$_SESSION['id_proff']}");
                        return false;
                }
                else{
                    if($_id == ""){
                        ...
                        if($_id !== $ID){
                            ...
                            while($user_data = mysqli_fetch_object($mysql_resul)){
                                ...
                                $Nome_proff = $user_data->Nome_proff;
                                $Cpf_Proff = $user_data->Cpf_proff;
                                $curso = $user_data->curso;
                                $sala = $user_data->sala;
                                $turno = $user_data->Turno;
                                $Ativo = $user_data->Ativo_proff;
                            }
...
<div class="conteiner-back">
    ...
    <h2 class="free-contente">Lista do Professor(a) <?php echo $Nome_proff; ?></h2>
    <?php
    ...
    <div class="conteiner_box_principal">
        <div class="sub_conteiner_box_principal">
            ...
            <form action="_saved_proff.php?prof=<?php echo $id_proff ?>" method="POST">
            <div class="sub_card_name_edit">
                ...
                <?php
                  echo "<input type='text' name = 'name_proff' value='$Nome_proff'>";
                ?>
            </div>
            ...
            <path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 12.5V5a1 1 0 0 1-1-1V2zm2 3v7.5A1.5 1.5 0 0 0 3.5 14h9a1.5 1.5 0 0 0 1.5-1.5V5H2zm13-3H1v2h14V2zM5 7.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>
                ...
                <?php
                     echo "<input type='text' name='cpf_proff' value='$Cpf_Proff'>";
                ?>
            </div>
            ...
            <path d="M2 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H9.5a1 1 0 0 0-1 1v7.293l2.646-2.647a.5.5 0 0 1 .708.708l-3.5 3.5a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L7.5 9.293V2a2 2 0 0 1 2-2H14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h2.5a.5.5 0 0 1 0 1H2z"/>
                ...
                <?php
                    echo "<input type='hidden' name='id_proff_edit'value='{$id_proff}'>";

<?php
    ...
    if(isset($_POST['update_submit_proff'])){
        ...
        if(isset($_GET['alun'])){
            ...
            if($id_proff == ""){
                header("Location:_edit_aluno.php?alun={$id_proff_edit}");
                        return false;
            }
            else{
                    ...
                    if($id_proff_edit == ""){
                        ...
                        if($id_proff_edit !== $id_proff || $id_proff !== $id_proff_edit ){
                            ...
                            if($op_turno == "none"){
                                ...
                                $update_turn = "UPDATE aluno SET Nome_aluno = '{$name_proff}' , Cpf_aluno = '{$cpf_proff}' , curso ='{$op_curso}', sala = '{$sala_proff}',Turno = '{$op_turno}' WHERE id_aluno = '{$id_proff_edit}'";
